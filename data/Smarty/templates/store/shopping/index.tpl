<div id="undercolumn">
    ...
    <div id="undercolumn_login" class="ui-section">
                ...
                <div class="inputbox">
                    <dl class="formlist clearfix">
                        ...
                        <dd>
                            ...
                            <input type="text" name="<!--{$key}-->" value="<!--{$tpl_login_email|h}-->" maxlength="<!--{$arrForm[$key].length}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->; ime-mode: disabled;" class="box300 form-control input-sm" />
                    ...
                    <dl class="formlist clearfix">
                        ...
                        <dd>
                            <input type="password" name="<!--{$key}-->" maxlength="<!--{$arrForm[$key].length}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" class="box300 form-control input-sm" />
                        </dd>
                    </dl>
                    <div class="btn_area">
            ...
            <form name="member_form2" id="member_form2" method="post" action="?">
                ...
                <div class="inputbox">
                    <div class="btn_area">
                        <ul class="list-inline">
                            <li>
                                <input type="submit" class="btn btn-main" value="購入手続きへ" name="buystep" id="buystep" />
                            </li>
                        </ul>
                    </div>
                </div>
