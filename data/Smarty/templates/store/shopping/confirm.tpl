    ...
    <div id="undercolumn_shopping" class="ui-section">
        ...
        <form name="form1" id="form1" method="post" action="?">
            ...
            <div class="btn_area">
                <ul class="list-inline">
                    <li>
                        ...
                        <!--{if $use_module}-->
                    <li>
                        <input type="submit" onclick="return fnCheckSubmit();" class="btn btn-main" value="次へ" name="next-top" id="next-top" />
                    </li>
                        <!--{else}-->
                    <li>
                        <input type="submit" onclick="return fnCheckSubmit();" class="btn btn-main" value="ご注文完了ページへ" name="next-top" id="next-top" />
                    </li>
                    <!--{/if}-->
                </ul>
            </div>
            ...
            <!--{if $tpl_login == 1 && $smarty.const.USE_POINT !== false}-->
                <table summary="ポイント確認" class="delivname table table-bordered">
                <col width="30%" />
                <col width="70%" />
                    <tr>
            ...
            <table summary="ご注文者" class="customer table table-bordered">
                <col width="30%" />
                <col width="70%" />
                <tbody>
                    <tr>
            ...
            <!--{foreach item=shippingItem from=$arrShipping name=shippingItem}-->
                ...
                <table summary="お届け先確認" class="delivname table table-bordered">
                    <col width="30%" />
                    <col width="70%" />
                    <tbody>
                        <tr>
            ...
            <table summary="配送方法・お支払方法・その他お問い合わせ" class="delivname table table-bordered">
                <col width="30%" />
                <col width="70%" />
                <tbody>
                <tr>
            ...
            <div class="btn_area">
                <ul class="list-inline">
                    ...
                    <!--{if $use_module}-->
                    <li>
                        <input type="submit" onclick="return fnCheckSubmit();" class="btn btn-main" value="次へ" name="next" id="next" />
                    </li>
                    <!--{else}-->
                    <li>
                        <input type="submit" onclick="return fnCheckSubmit();" class="btn btn-main" value="ご注文完了ページへ"  name="next" id="next" />
                    </li>
                    <!--{/if}-->
                </ul>
            </div>
