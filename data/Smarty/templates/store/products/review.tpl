    ...
    <form name="form1" id="form1" method="post" action="?">
        ...
        <table class="table table-bordered" summary="お客様の声書き込み">
            ...
            <tr>
                ...
                <td><span class="attention"><!--{$arrErr.reviewer_name}--></span><input type="text" name="reviewer_name" value="<!--{$arrForm.reviewer_name|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.reviewer_name|sfGetErrorColor}-->" class="box350 form-control input-sm" /></td>
            </tr>
            <tr>
                <th>投稿者URL</th>
                <td><span class="attention"><!--{$arrErr.reviewer_url}--></span><input type="text" name="reviewer_url" value="<!--{$arrForm.reviewer_url|h}-->" maxlength="<!--{$smarty.const.MTEXT_LEN}-->" style="<!--{$arrErr.reviewer_url|sfGetErrorColor}-->" class="box350 form-control input-sm" /></td>
            </tr>
            <tr>
                <th>性別</th>
                <td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <select name="recommend_level" style="<!--{$arrErr.recommend_level|sfGetErrorColor}-->" class="form-control input-sm">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" name="title" value="<!--{$arrForm.title|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.title|sfGetErrorColor}-->" class="box350 form-control input-sm" />
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <textarea name="comment" cols="50" rows="10" style="<!--{$arrErr.comment|sfGetErrorColor}-->" class="area350 form-control"><!--{"\n"}--><!--{$arrForm.comment|h}--></textarea>
                </td>
            </tr>
        </table>
        <div class="btn_area">
            <ul class="list-inline">
                <li>
                    <input type="submit" class="btn btn-main" value="確認ページへ" name="conf" id="conf" />
                </li>
            </ul>
        </div>
    </form>
