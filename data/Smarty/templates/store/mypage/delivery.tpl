<div id="mypagecolumn">
    ...
    <div id="mycontents_area" class="ui-section">
        ...
        <!--{if $tpl_linemax < $smarty.const.DELIV_ADDR_MAX}-->
            ...
            <!--{if $tpl_login}-->
              <p class="add_address">
                  <a href="<!--{$smarty.const.ROOT_URLPATH}-->mypage/delivery_addr.php" onclick="eccube.openWindow('./delivery_addr.php','delivadd','600','640',{menubar:'no'}); return false;" target="_blank" class="btn btn-default">新しいお届け先を追加</a>
              </p>
            <!--{/if}-->
        <!--{/if}-->
