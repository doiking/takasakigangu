    ...
    <div id="mycontents_area" class="ui-section">
        ...
        <div class="mycondition_area clearfix">
            ...
            <form action="order.php" method="post">
                ...
                <p class="btn">
                    ...
                    <input type="submit" class="btn btn-default" value="この購入内容で再注文する" name="submit" />
                </p>
            </form>
            <br />
        </div>
        ...
        <!--{foreach item=shippingItem name=shippingItem from=$arrShipping}-->
            <div class="content-title">
                <h3 class="title">お届け先<!--{if $isMultiple}--><!--{$smarty.foreach.shippingItem.iteration}--><!--{/if}--></h3>
            </div>
            <!--{if $isMultiple}-->
            ...
            <!--{/if}-->
            <table summary="お届け先" class="delivname table table-bordered">
                <col width="30%" />
                <col width="70%" />
                <tbody>
                    <tr>
